...
public class ForgeRegistrationFactory implements RegistrationProvider.Factory {
    ...
    public <T> RegistrationProvider<T> create(ResourceKey<? extends Registry<T>> resourceKey, String modId) {
        ...
        return new Provider<>(modId, resourceKey, registryFactory, getModEventBus(modId));
    }
    ...
    // Forge registries have no vanilla registry view unless they are created with tags, so expose them through a minimal wrapper
